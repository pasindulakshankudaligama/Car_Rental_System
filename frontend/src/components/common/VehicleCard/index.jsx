...
class VehicleCard extends Component {
    constructor(props) {
        super(props);
        this.state={
            img:props.obj.img.length!==0?'http://localhost:8080/backend/'+props.obj.img[0].path:'https://images.unsplash.com/photo-1583267746897-2cf415887172?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YXV0b21vYmlsZXxlbnwwfHwwfHw%3D&w=1000&q=80g'
        }
    }
                    ...
                    <div className="text-white flex flex-col justify-between">
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div>{vehicle.no_Of_Passengers}</div>
                            </div>
                            <div>
                                <div className="flex flex-col items-center">
